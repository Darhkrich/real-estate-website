...
export default function AgentsPage() {
  ...
  const allSpecialties = useMemo(() => {
    ...
    agents.forEach((agent) => {
      agent.specialty?.forEach((s) => specialties.add(s));
    });
  ...
  const allLanguages = useMemo(() => {
    ...
    agents.forEach((agent) => {
      agent.languages?.forEach((l) => languages.add(l));
    });
  ...
  // Handle contact actions without triggering card navigation
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 pt-24 pb-16 px-6 text-center">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto text-lg">
          Industry-leading professionals dedicated to providing unparalleled service
          and market expertise. Meet the experts who will guide you home.
        </p>
      </div>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 py-12 w-full">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <select
              ...
              className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 text-gray-700"
            >
          ...
          <div className="flex items-center justify-between mt-4">
            <p className="text-sm text-gray-600">
              Showing <span className="font-semibold text-gray-900">{filteredAgents.length}</span>{' '}
        ...
        {filteredAgents.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
            ...
            <h3 className="text-2xl font-bold text-gray-900">No agents found</h3>
  ...
  />
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-600 mb-4 pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        <strong>{agent.activeListings}</strong> active listings
                      </span>
                    </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-white/90 max-w-2xl mx-auto mb-6">
            Are you a top-performing real estate professional? Join Prime Estate and
            elevate your career with unparalleled support and exclusive listings.
          </p>
          <Link
            href="/careers"
