...
export default function CareersPage() {
  const openings = [
    ...
    {
      title: 'Client Concierge Coordinator',
      location: 'New York, NY',
      type: 'Full-time',
    },
  ];
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Access to exclusive listings, mentorship from top producers, and a clear path to leadership.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Represent a globally recognized luxury brand with a reputation for excellence.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Work alongside industry veterans who share knowledge and celebrate collective success.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Cutting-edge technology, marketing support, and administrative assistance to help you focus on clients.
                </p>
              </div>
            </div>
          </div>
          ...
          {openings.length > 0 ? (
            <div className="space-y-3">
              {openings.map((job, idx) => (
                <div
                  key={idx}
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors"
                >
                  <div>
                  ...
                  <a
                    ...
                    className="mt-3 sm:mt-0 inline-flex items-center text-amber-600 text-sm font-medium hover:text-amber-700"
                  >
                    Apply Now →
                  </a>
                </div>
            ...
            <p className="text-gray-600">No open positions at this time. Check back soon!</p>
          )}
        </section>
